                    ...
                    <div className="lg:pl-20">
                      ...
                      <div className="mb-3">
                        ...
                        <p>
                          ...
                          elit. Rerum iste corporis quos quas earum obcaecati
                          facere ipsum perferendis consectetur officia tempora
                          corrupti, illum cupiditate voluptas quisquam ut optio
                          consequuntur aut.
                        </p>
                      </div>
                          ...
                          <div className="mb-16 h-auto py-8 px-4 lg:px-8 rounded-md mx-auto bg-white shadow-xl relative">
                            ...
                            <div className="mt-4">
                              <p className="text-sm leading-relaxed text-justify">
                                ...
                                adipisicing elit. Maxime, totam! Lorem ipsum
