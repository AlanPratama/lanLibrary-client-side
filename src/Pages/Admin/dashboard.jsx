        ...
        <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-x-2 gap-y-12">
          <div className="text-center py-6 bg-blue-600 rounded-lg shadow">
            <svg
              ...
              className="fill-white w-10 inline-block"
              viewBox="0 0 512 512"
            >
              <path
          ...
          <div className="text-center py-6 bg-blue-600 rounded-lg shadow">
            ...
            <h3 className="text-3xl font-extrabold text-white mt-5">450+</h3>
          ...
          <div className="text-center py-6 bg-blue-600 rounded-lg shadow">
            ...
            <h3 className="text-3xl font-extrabold text-white mt-5">500+</h3>
          ...
          <div className="text-center py-6 bg-blue-600 rounded-lg shadow">
            ...
            <h3 className="text-3xl font-extrabold text-white mt-5">600+</h3>
