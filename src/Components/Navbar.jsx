    ...
    return (
      <div className="px-4 py-5 mx-auto sticky top-0 bg-white z-50 sm:max-w-xl md:max-w-full lg:max-w-screen-full md:px-24 lg:px-8">
        <div className="relative flex grid items-center grid-cols-2 lg:grid-cols-3">
          <ul className="flex items-center hidden space-x-8 lg:flex">
            ...
            <li>
              <a
                ...
                aria-label="Our product"
                title="Our product"
                className={`font-medium tracking-wide ${isActive == 'popularBook' ? 'text-blue-700' : 'text-gray-700'} transition-colors duration-200 hover:text-deep-purple-accent-400`}
              >
                Popular Book
              </a>
            </li>
            <li>
              <a
                ...
                className={`font-medium tracking-wide ${isActive == 'allBook' ? 'text-blue-700' : 'text-gray-700'} transition-colors duration-200 hover:text-deep-purple-accent-400`}
              >
                All Book
              </a>
            </li>
          ...
          >
            <img src="/assets/lanLib-lg.png" alt="Lan Library" className="w-[30px] mr-1 p-0 text-deep-purple-accent-400" />
